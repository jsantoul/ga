...
def test():
    ...
    population_filename = os.path.join(SRC_PATH,'data_fr',
                                       'proj_pop_insee','proj_pop.h5')
    profiles_filename = os.path.join(SRC_PATH,'data_fr','profiles.h5')
    ...
    simulation.set_tax_projection(method="per_capita")
